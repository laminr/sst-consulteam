...
<body id="details">
	...
	<div class="container">
		<section id="SST" name="SST" class="clearfix">
			<h1>Formation <strong class="black">EPI</strong></h1>
			<div class="row">
				<div class="span7 padding-plus">
					<div class="row">
						<div class="span7">
							<p>
								La fomation de <em>prévention et secours civiques</em> est une formation .......
							</p>
							<p>
			                	Le Moniteur forme des candidats sans connaissances particulières d’une durée minimum de 10 heures avec pour objectif de préparer le plus grand nombre de citoyens aux rudiments de premiers secours.
		                	</p>
		                	<p>
				...
				<div class="span5">
					<img class="pull-right" src="img/logo-EPI.png" alt="logo EPI">
				</div>
			</div>
		</section>
